...
public class MessageTester {
	...
	public void testConstructor() {
		...
		assertEquals("This is content test", msg.getContent());
	}
	...
	public void testGetReceiverId() {
		assertEquals(new HashSet<>(Arrays.asList(4,5,6)),msg.getReceiverIds());
	}
	...
	public void testGetContent() {
		assertEquals("Testing get Content",msg.getContent());
	}
}
